...
{% include figure.html path="assets/img/CTD_sunset.jpg" caption="Using a CTD at sunset to collect water samples onboard the R/V Thomas G. Thompson in the equatorial Pacific" class="img-fluid rounded z-depth-1" %}
